...
<html>
    ...
    <!-- botones -->
        ...
        <script type="text/javascript">
            var id = null;
            function submitFormTipoInstitucion() {
                    ...
                    buttons : {
                        ...
                        eliminar : {
                            ...
                            callback  : function () {
                                ...
                                $.ajax({
                                    type    : "POST",
                                    url     : '${createLink(controller:'tipoInstitucion', action:'delete_ajax')}',
                                    data    : {
                                        id : itemId
                                    },
                                    success : function (msg) {
                        ...
                        var b = bootbox.dialog({
                            ...
                            buttons : {
                                ...
                                guardar  : {
                                    ...
                                    callback  : function () {
                                        return submitFormTipoInstitucion();
                                    } //callback
                                } //guardar
                            } //buttons
                        }); //dialog
                    ...
                    items  : {
                        ...
                        ver      : {
                            ...
                            action : function ($element) {
                                ...
                                $.ajax({
                                    type    : "POST",
                                    url     : "${createLink(controller:'tipoInstitucion', action:'show_ajax')}",
                                    data    : {
                                        id : id
                                    },
                                    success : function (msg) {
